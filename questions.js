const questionBank = [
  ...
  {
    id: "ch4_new_01",
    question: "在呼叫副程式時，可以 Stack 用來存放其中的一些資訊，何者不是",
    options: ["區域變數", "參數值", "呼叫時的位置", "副程式名稱"],
    answer: 3,
    explanation: "Stack 常存放區域變數、參數值、返回位址等資訊，不會特別存放副程式名稱。"
  },
  {
    id: "ch4_new_02",
    question: "佇列的存取策略為",
    ...
    answer: 3,
    explanation: "Queue 的特性是 First In First Out，也就是 FIFO。"
  },
  {
    id: "ch4_new_03",
    question: "後序表示式【36 10 5 3 / 6 - * + 3 5 3 / * +】的計算結果為",
    options: ["53", "-8", "-11", "-12"],
    answer: 2,
    explanation: "以整數除法計算：5/3=1，(1-6)=-5，10*(-5)=-50，36+(-50)=-14；5/3=1，3*1=3；最後 -14+3=-11。"
  },
  {
    id: "ch4_new_04",
    question: "捷運系統旅客依序搭乘手扶梯進出站，屬於以下哪一種資料結構？",
    options: ["堆積(Heap)", "雜湊(Hash)", "堆疊(Stack)", "佇列(Queue)"],
    answer: 3,
    explanation: "先進先出，屬於 Queue。"
  },
  {
    id: "ch4_new_05",
    question: "下列哪一種資料結構適合處理「後進先出」(Last-in-First-out) 的資料？",
    options: ["堆疊(Stack)", "堆積(Heap)", "佇列(Queue)", "雜湊(Hash)"],
    answer: 0,
    explanation: "LIFO 對應 Stack。"
  },
  {
    id: "ch4_new_06",
    question: "若將 1、2、3、4 依序放入 Stack，則哪一種輸出是不可能的",
    options: ["1234", "1423", "3214", "2134"],
    answer: 1,
    explanation: "1423 無法由合法的 push / pop 順序產生。"
  },
  {
    id: "ch4_new_07",
    question: "後序表示式【10 8 + 6 5 * -】的計算結果為",
    options: ["53", "-8", "-11", "-12"],
    answer: 3,
    explanation: "10+8=18，6*5=30，18-30=-12。"
  },
  {
    id: "ch4_new_08",
    question: "若將 1、2、3 依序放入 Stack，則哪一種輸出是不可能的",
    options: ["132", "312", "213", "231"],
    answer: 1,
    explanation: "312 不可能。若 3 先出來，表示 1、2 都還在 3 下面，下一個不可能直接變成 1。"
  },
  {
    id: "ch4_new_09",
    question: "中序表示式【A*負B/正C】的前序表示式為",
    options: ["AB負C正/*", "/*A負B正C", "AB負*C正/", "*A/負B正C"],
    answer: 1,
    explanation: "A*負B/正C = (A * (-B)) / (+C)，前序為 /*A負B正C。"
  },
  {
    id: "ch4_new_10",
    question: "中序表示式【A*B/C】的前序表示式為",
    options: ["*A/BC", "/*ABC", "ABC/*", "AB*C/"],
    answer: 1,
    explanation: "A*B/C = (A*B)/C，所以前序表示式為 /*ABC。"
  },
  {
    id: "ch4_new_11",
    question: "後序表示式【10 3 / 2 5 - * 8 9 * + 10 -】的計算結果為",
    options: ["-12", "-11", "53", "-8"],
    answer: 2,
    explanation: "10/3=3，2-5=-3，3*(-3)=-9，8*9=72，-9+72=63，63-10=53。"
  },
  {
    id: "ch4_new_12",
    question: "若 x=1; y=2; z=--x + --y; 則 (x,y,z) 最後的值為",
    options: ["2,1,3", "0,3,2", "2,3,4", "0,1,1"],
    answer: 3,
    explanation: "--x 先變成 0，--y 先變成 1，所以 z=0+1=1，結果為 (0,1,1)。"
  },
  {
    id: "ch4_new_13",
    question: "若想在 printf 中印出 10 進位的整數值，應該用",
    options: ["%o", "%x", "%d", "%f"],
    answer: 2,
    explanation: "%d 用來輸出十進位整數。"
  },
  {
    id: "ch4_new_14",
    question: "若 x=1; y=2; z=x++ + y--; 則 (x,y,z) 最後的值為",
    ...
    answer: 3,
    explanation: "x++ 先用 1 再變 2，y-- 先用 2 再變 1，所以 z=1+2=3，結果為 (2,1,3)。"
  },
  {
    id: "ch4_new_15",
    question: "若將 1、2、3、4 依序放入 Stack，則哪一種輸出是不可能的",
    ...
    answer: 3,
    explanation: "2413 不可能由合法的堆疊操作產生。"
  },
  {
    id: "ch4_new_16",
    question: "有一個堆疊(Stack)，經由【push A, push B, push C, pop, push D, pop, push E, pop, pop, pop】輸出結果為以下何者？",
    options: ["CDEBA", "EDCBA", "BCADE", "ABCDE"],
    answer: 0,
    explanation: "依序 pop 出來為 C、D、E、B、A，所以答案是 CDEBA。"
  },
  {
    id: "ch4_new_17",
    question: "後序表示式【5 3 / 1 4 - * 3 + 8 -】的計算結果為",
    options: ["-8", "53", "-11", "-12"],
    answer: 0,
    explanation: "5/3=1，1-4=-3，1*(-3)=-3，-3+3=0，0-8=-8。"
  }
];
